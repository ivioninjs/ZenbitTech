  ...
  return (
    <React.Fragment>
      <BackgroundLayer>
        <Container>
          <Content>
            <Box margin="179px 0 177px 147px">
              <Form />
            </Box>
          </Content>
        </Container>
        ...
        <Layer zIndex={1} bottom="14%" left="12%">
          <Shape variant="cloud" width="132" heigh="99" opacity={0.4} />
        </Layer>
        <Layer zIndex={1} bottom="-6%" left="14%">
          <Shape variant="cloud" width="288" heigh="216" opacity={0.3} />
        </Layer>
        <Layer zIndex={1} bottom="5%" left="51%">
          <Shape variant="cloud" width="168" heigh="128" opacity={0.4} />
        </Layer>
        <Layer zIndex={1} top="20%" left="2%">
          <Shape variant="cloud" width="245" heigh="184" opacity={0.3} />
        </Layer>
        <Layer zIndex={1} top="15%" right="48%">
          <Shape variant="cloud" width="138" heigh="103" opacity={0.4} />
        </Layer>
        <Layer zIndex={1} top="28%" right="41%">
          <Shape variant="cloud" width="172" heigh="129" opacity={0.5} />
        </Layer>
        <Layer zIndex={2} top="2%" right="46%">
          <Shape variant="sun" width="87" heigh="87" />
        </Layer>
        <Layer zIndex={4} top="4%" left="8%">
          <Shape variant="three" />
        </Layer>
        <Layer zIndex={4} top="56%" right="39%">
          <Shape variant="two" />
        </Layer>
        <Layer zIndex={3} top="65%" right="32%">
          <Shape variant="one" />
        </Layer>
      </BackgroundLayer>
      <Footer />
